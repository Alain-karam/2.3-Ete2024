...
bool test1() {
  ...
  if (reussi) std::cout << " ==> OK" << std::endl;
  return reussi;
}
...
bool test2() {
  ...
  Tableau<int> t;
  int n = 256 * 256;
  for (int i = 0; i < n; i++) t.ajouter(i * 2);
...
bool test3() {
  ...
  Tableau<int> t1;
  for (int i = 0; i < 10; i++) t1.ajouter(i);
  Tableau<int> t2;
  t2 = t1;
...
bool test5() {
  ...
  t2 = t1;
  t1.vider();
  for (int i = 0; i < 100; i++) t1.ajouter(i + 1);
  t2 = t1;
  ...
  for (int i = 0; i < t2.taille(); i++)
    if (t2[i] != i + 1) {
      std::cout << " ==> ECHEC : t2[i]=" << t2[i] << "!=" << (i + 1)
                << std::endl;
      return false;
    }

  Tableau<int> t3;
  for (int i = 0; i < 100; i++) t3.ajouter(i);
  Tableau<int> t4;
  t4 = t3;
  t3.vider();
  for (int i = 0; i < 10; i++) t3.ajouter(i + 1);
  t4 = t3;
...
bool test6() {
  ...
  Tableau<int> t1, t2;
  for (int i = 0; i < 100; i++) t1.ajouter(i);
...
int main() {
  bool testsreussis = true  // Cette ligne «true» a été insérée pour facilier la
                            // mise en commentaire de la ligne suivante.
                      && test1() && test2() && test3() && test4() && test5()
                      && test6() && test7() && test8() && test9() && test10()
                      && test11() && test12();

  std::cout << std::endl << std::endl << "**** Sommaire ****" << std::endl;
