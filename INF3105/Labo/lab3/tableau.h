...
int Tableau<T>::chercher(const T& element) const {
  // Voir la fonction Tableau<T>::contient() dans les notes de cours
  // (Section 4.7). Il suffit de l'adapter pour retourner la position au lieu
  // d'un booléen.
